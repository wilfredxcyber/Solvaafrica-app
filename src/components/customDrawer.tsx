    ...
    return (
        <DrawerContentScrollView style={styles.drawerView}>
            <View style={styles.drawerHeaderView}>
                <AvatarView />
                <Text style={{ fontFamily: 'Inter-Bold', marginTop: hscale(12), fontSize: mscale(18) }}>{fullName}</Text>
            </View>

            <Pressable onPress={() => handleSetActiveProfile('Profile')} style={styles.customDrawerItem}>
                <Text style={[styles.activeScreenTextLink, { color: activeScreen === 'Profile' ? colors.primary : colors.bodyText }]}>Profile</Text>
            </Pressable>
            <Pressable onPress={() => handleSetActiveProfile('Complaints')} style={styles.customDrawerItem}>
                <Text style={[styles.activeScreenTextLink, { color: activeScreen === 'Complaints' ? colors.primary : colors.bodyText }]}>Complaints</Text>
            </Pressable>
            ...
            <View style={{ justifyContent: 'flex-end', height: '80%' }}>
                ...
                <Pressable style={styles.logoutView} onPress={handleLogout}>
                    ...
                    <Text style={{ fontFamily: 'Inter-Bold', fontSize: mscale(16), color: '#ffffff', marginLeft: 8 }}>Logout</Text>
                </Pressable>
            </View>
...
const styles = StyleSheet.create({
    drawerHeaderView: {
        ...
        borderBottomWidth: StyleSheet.hairlineWidth, borderColor: '#C9CFC9',
    },
    drawerView: { backgroundColor: '#F5F6F5', paddingHorizontal: screenHorizontalPadding },
    socialIconsView: { flexDirection: 'row', justifyContent: 'space-between', width: '80%', alignSelf: 'center', },
    logoutView: {
        flexDirection: 'row',
    ...
    customDrawerItem: { paddingVertical: hscale(20), borderBottomWidth: StyleSheet.hairlineWidth, borderColor: '#C9CFC9', justifyContent: 'center' }
})
